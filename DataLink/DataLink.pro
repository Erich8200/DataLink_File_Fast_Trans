...
SOURCES += \
    ...
    SessionStrategy/on_file_recv_strategy.cpp \
    SessionStrategy/on_hello_strategy.cpp \
    StrategyFactory/on_file_recv_strategy_factory.cpp \
...
HEADERS += \
    ...
    SessionStrategy/on_file_recv_strategy.h \
    SessionStrategy/on_hello_strategy.h \
    StrategyFactory/on_file_recv_strategy_factory.h \
...
#    win32: DEPENDPATH += ../AsyncServer_VS/x64
    win32:CONFIG(debug, debug|release): {
        LIBS += -L../../AsyncServer_VS/x64/Debug -lAsyncServerLib
        ...
        LIBS += -L../../AsyncServer_VS/x64/Release -lAsyncServerLib
    ...
    win32:CONFIG(debug, debug|release): {
        LIBS += -L../../AsyncServer_VS/Debug -lAsyncServerLib
        ...
        LIBS += -L../../AsyncServer_VS/Release -lAsyncServerLib \
...
RC_ICONS = icons/database-64px.ico
